...
export const LANDING_I18N: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    install_btn: "바로가기 만들기",
    install_modal_title: "홈 화면에 추가",
    install_modal_step1: "1. 하단의 공유 버튼을 탭하세요",
    install_modal_step2: '2. "홈 화면에 추가"를 선택하세요',
    install_modal_step3: '3. "추가"를 탭해 완료하세요',
    install_modal_close: "닫기",
    install_only_mobile: "모바일에서만 사용 가능합니다",
    install_already: "이미 홈 화면에 추가되어 있습니다",
    feat_label: "Features",
  ...
  en: {
    ...
    install_btn: "Add Shortcut",
    install_modal_title: "Add to Home Screen",
    install_modal_step1: "1. Tap the Share button at the bottom",
    install_modal_step2: '2. Select "Add to Home Screen"',
    install_modal_step3: '3. Tap "Add" to finish',
    install_modal_close: "Close",
    install_only_mobile: "Available on mobile only",
    install_already: "Already added to your home screen",
    feat_label: "Features",
  ...
  ja: {
    ...
    install_btn: "ショートカット作成",
    install_modal_title: "ホーム画面に追加",
    install_modal_step1: "1. 下部の共有ボタンをタップ",
    install_modal_step2: "2. 「ホーム画面に追加」を選択",
    install_modal_step3: "3. 「追加」をタップして完了",
    install_modal_close: "閉じる",
    install_only_mobile: "モバイルのみ利用可能です",
    install_already: "すでにホーム画面に追加されています",
    feat_label: "機能",
  ...
  zh: {
    ...
    install_btn: "添加快捷方式",
    install_modal_title: "添加到主屏幕",
    install_modal_step1: "1. 点击底部的分享按钮",
    install_modal_step2: '2. 选择"添加到主屏幕"',
    install_modal_step3: '3. 点击"添加"完成',
    install_modal_close: "关闭",
    install_only_mobile: "仅在移动端可用",
    install_already: "已添加到主屏幕",
    feat_label: "功能特色",
